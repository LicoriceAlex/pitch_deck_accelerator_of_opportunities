...
def calc_stuff(revenue=100_000, revenue_new=110_000, clients=300):
    ...
    rev_path = os.path.join('presentations', 'figs', 'revenue.png')
    fig.write_image(rev_path)

    return apru, churn, ltv, rev_path
...
def make_req(money : int, raund : str, need : str):
    ...
    pie_path = os.path.join('presentations', 'figs', 'pie.png')
    fig.write_image(pie_path)
    return pie_path
